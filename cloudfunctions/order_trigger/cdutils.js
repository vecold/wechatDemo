...
function api({ url,params }){
  return new Promise((resolve, reject) => {
    rp(
      {
        method: 'post',
        uri: 'https://wechat.aiyongbao.com/' + url,
        // uri: 'https://devwechat.aiyongbao.com/' + url,
        formData: params,//参数
        headers: {},//请求头
        json: true  //是否json数据
      }
...
function savefund({ nick, shopId, shop_funds }) {
  return new Promise((resolve, reject) => {
...
function updatefund({ nick, shopId, shop_funds }){
  return new Promise((resolve, reject) => {
    db.collection('shop_funds').where({
      nick: nick,
      shopId: JSON.stringify(shopId + ''),
